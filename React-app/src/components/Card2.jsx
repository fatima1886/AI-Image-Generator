...
const Card2 = ({ imageUrl,loading }) => {
  return (
    <>
{loading && <div className="relative w-full h-full aspect-square border border-zinc-800 rounded-xl bg-zinc-950 flex flex-col items-center justify-center overflow-hidden shadow-2xl">
...
<div className="absolute inset-0 bg-gradient-to-t from-[#161616]/95 via-[#161616]/40 to-[#df7829]/25 z-0 mix-blend-screen"></div>
  ...
  {imageUrl && <div       className=" border border-zinc-800 rounded-2xl flex flex-col items-center justify-center  text-center group min-h-[400] h-full w-full sm:h-[95vh] relative overflow-hidden">
